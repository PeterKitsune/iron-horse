...
class SchemaBase(object):
    ...
    @property
    def catalogue(self):
        # I previously tried enforcing that all catalogue access is via catalogue_entry.catalogue, but it was unwieldy
        # direct accessor for catalogue is better
    ...
    def vehicle_life(self):
        ...
        if self.catalogue.cab_engine_model is not None:
            return self.catalogue.cab_engine_model.vehicle_life
    ...
    def engine_sprite_layers_with_layer_names(self):
        ...
        if self.decor_spriterow_num is not None:
            ...
            if self.decor_spriterow_num <= len(self.catalogue) - 1:
                raise BaseException(
                    self.model_id
                    + " has decor_spriterow_num "
                    + str(self.decor_spriterow_num)
                    + " and also "
                    + str(len(self.catalogue) - 1)
...
class TGVMiddleMailEngine(TGVMiddleEngineMixin, MailEngineBase):
    ...
    def subrole_child_branch_num(self):
        ...
        if self.catalogue.cab_engine_model.subrole_child_branch_num < 0:
            offset = -2000
        else:
            offset = 2000
...
class CarSchemaBase(SchemaBase):
    ...
    def model_life(self):
        ...
        if self.catalogue.cab_engine_model is not None:
            return self.catalogue.cab_engine_model.model_life
...
class RandomisedCarMixinBase(object):
    """
...
class AutomobileCarBase(CarSchemaBase):
    ...
    liveries = [
        "RANDOM_LIVERIES_COMPLEMENT_COMPANY_COLOUR_NO_WEATHERING",
        "RANDOM_LIVERIES_BUMBLEBEE_NO_WEATHERING",
        ...
        "RANDOM_LIVERIES_TEAL_OCEAN_TEAL_NO_WEATHERING",
    ]
...
class BulkOpenCarTipplerBase(BulkOpenCarBase):
    ...
    # Tipplers tend to look better with _relatively_ consistent colours
    # so the most random sets aren't used and more single colour sets are used
    liveries = [
        "RANDOM_LIVERIES_COMPLEMENT_COMPANY_COLOUR",
        "RANDOM_LIVERIES_OCHRE_SAND",
        "RANDOM_LIVERIES_SILVER_GREY_PEWTER_NO_WEATHERING",
...
class CoveredHopperCarSwingRoofBase(CoveredHopperCarBase):
    ...
    liveries = [
        ...
        "RANDOM_LIVERIES_CLOVER_OCHRE_SAND",
        "RANDOM_LIVERIES_TEAL_PEWTER_SILVER",
        # "RANDOM_LIVERIES_VARIETY_GEMSTONE", # tried it, don't like
        "RANDOM_LIVERIES_GREY_RUST_NIGHTSHADE",
        "RANDOM_LIVERIES_OIL_BLACK_OBSIDIAN_NIGHTSHADE",
        "RANDOM_LIVERIES_OXIDE_RUST",
        "FREIGHT_KALE",
...
class ExpressCarBase(CarSchemaBase):
    ...
    randomised_candidate_groups = [
        ...
        "food_express_box_combos",
        "food_express_liquid_combos",
    ]
...
class FarmCargoCombosBase(RandomisedCarComboMixin, CarSchemaBase):
    ...
    liveries = [
        "RANDOM_LIVERIES_CLOVER_OCHRE_SILVER"
    ]  # only one livery, as farm product cars have fixed colour
...
class FarmCargoMixedCombos(FarmCargoCombosBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.gestalt_graphics = GestaltGraphicsRandomisedWagonSimpleBodyColourRemaps(
            ...
            dice_colour=2,
            buy_menu_id_pairs=[
                ["farm_product_hopper_car_type_1"],
                ["merchandise_box_car"],
            ],
            catalogue_entry=self.catalogue_entry,
        )
...
class FarmCargoHopperCombos(FarmCargoCombosBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.gestalt_graphics = GestaltGraphicsRandomisedWagonSimpleBodyColourRemaps(
            ...
            dice_colour=1,
            buy_menu_id_pairs=[
                ["covered_hopper_car_type_2", "covered_hopper_car_type_1"],
                ["farm_product_hopper_car_type_2", "farm_product_hopper_car_type_1"],
            ],
            catalogue_entry=self.catalogue_entry,
        )
...
class FarmProductsHopperCarRandomised(
    RandomisedCarVanillaMixin, FarmProductsHopperCarBase
):
    """
...
class FoodIngredientsMixedCombos(FoodIngredientsCombosBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.gestalt_graphics = GestaltGraphicsRandomisedWagonSimpleBodyColourRemaps(
            ...
            dice_colour=2,
            buy_menu_id_pairs=[
                ["food_hopper_car_type_3", "food_hopper_car_type_1"],
                ["merchandise_box_car"],
            ],
            catalogue_entry=self.catalogue_entry,
        )
...
class FoodProductsHopperCarRandomised(
    RandomisedCarVanillaMixin, FoodProductsHopperCarBase
):
    """
...
class FoodExpressBoxCombos(RandomisedCarComboMixin, FoodExpressCarBase):
    ...
    model_id_root = "food_express_box_combos"
    ...
    def __init__(self, **kwargs):
        ...
        self.gestalt_graphics = GestaltGraphicsRandomisedWagonSimpleBodyColourRemaps(
            ...
            dice_colour=2,
            buy_menu_id_pairs=[
                ["reefer_car_type_2", "reefer_car_type_1"],
                ["express_car_type_2", "express_car_type_1"],
            ],
            catalogue_entry=self.catalogue_entry,
        )
...
class FoodExpressLiquidCombos(RandomisedCarComboMixin, FoodExpressCarBase):
    ...
    model_id_root = "food_express_liquid_combos"
...
class FlatBedCargoCombos(RandomisedCarComboMixin, FlatCarBase):
    """
    Random choice of flatbed cargo car, from available flat cars, bolster cars etc.
    """

    model_id_root = "flatbed_cargo_combos"
    ...
    def __init__(self, **kwargs):
        ...
        self.gestalt_graphics = GestaltGraphicsRandomisedWagonSimpleBodyColourRemaps(
            ...
            dice_colour=2,
            buy_menu_id_pairs=[
                ["drop_end_flat_car", "flat_car"],
                ["pipe_car", "bolster_car"],
            ],
            catalogue_entry=self.catalogue_entry,
        )
...
class MetalProductCombosBase(RandomisedCarComboMixin, CoilCarBase):
    """
...
class MetalProductCoveredCombos(MetalProductCombosBase):
    """
    Random choice of cold metal car sprite, from suitable covered coil cars, vans etc.
    """

    model_id_root = "metal_product_covered_combos"
    ...
    def __init__(self, **kwargs):
        ...
        self.gestalt_graphics = GestaltGraphicsRandomisedWagonSimpleBodyColourRemaps(
            ...
            dice_colour=2,
            buy_menu_id_pairs=[
                ["coil_car_covered_asymmetric", "coil_car_covered"],
                ["tarpaulin_car_type_1", "sliding_roof_car"],
            ],
            catalogue_entry=self.catalogue_entry,
        )
...
class MetalProductMixedCombos(MetalProductCombosBase):
    ...
    model_id_root = "metal_product_mixed_combos"
    ...
    def __init__(self, **kwargs):
        ...
        self.gestalt_graphics = GestaltGraphicsRandomisedWagonSimpleBodyColourRemaps(
            ...
            dice_colour=1,
            buy_menu_id_pairs=[
                ["mill_open_car_type_1"],
                [
                    "coil_car_tarpaulin",
                    "coil_car_covered",
                    "mill_flat_car_type_2",
                    "bolster_car",
                ],
            ],
            catalogue_entry=self.catalogue_entry,
...
class MineralCoveredHopperCarLimeBase(MineralCoveredHopperCarBase):
    ...
    # limited choices, tried more, doesn't add anything
    liveries = [
        "RANDOM_LIVERIES_COMPLEMENT_COMPANY_COLOUR",
...
class MineralCoveredHopperCombos(RandomisedCarComboMixin, MineralCoveredHopperCarBase):
    """
    ...
    liveries = [
        "RANDOM_LIVERIES_COMPLEMENT_COMPANY_COLOUR",
        "RANDOM_LIVERIES_SILVER_GREY_PEWTER_NO_WEATHERING",
        "RANDOM_LIVERIES_CLOVER_OCHRE_SAND",  # might be odd, but intended for farm stuff
        "RANDOM_LIVERIES_TEAL_PEWTER_SILVER",
        "RANDOM_LIVERIES_GREY_RUST_NIGHTSHADE",
    ]

    model_id_root = "mineral_covered_hopper_combos"
...
class MineralCoveredHopperCarRollerRoofBase(MineralCoveredHopperCarBase):
    ...
    # minimal set by design, more don't add anything
    liveries = [
        "RANDOM_LIVERIES_COMPLEMENT_COMPANY_COLOUR",
        "RANDOM_LIVERIES_VARIETY_LIMEWASH_NO_WEATHERING",
        "RANDOM_LIVERIES_OXIDE_RUST",
...
class OpenCarMillBase(OpenCarBase):
    ...
    variant_group_id_root = "wagon_group_mill_open_cars"
    randomised_candidate_groups = [
        "metal_product_mixed_combos",
        "mill_open_car_randomised",
        "piece_goods_mixed_combos",
    ]
...
class OpenCarMillType2(OpenCarMillBase):
    """
    Open car for use in the steel industry, but widely repurposed and refittable.
    """

    model_id_root = "mill_open_car_type_2"

    def __init__(self, **kwargs):
        super().__init__(**kwargs)


class OpenCarMillRandomised(RandomisedCarVanillaMixin, OpenCarMillBase):
    """
    Random choice of mill open car.
    """

    model_id_root = "mill_open_car_randomised"
...
class PieceGoodsCombosCoveredRandomised(PieceGoodsCarRandomisedBase):
    """
...
class PieceGoodsCombosManufacturingPartsRandomised(PieceGoodsCarRandomisedBase):
    """
...
class SlidingRoofCarHiCube(BoxCarBase):
    ...
    randomised_candidate_groups = ["piece_goods_manufacturing_parts_combos"]
...
class ChemicalCargoTankCombos(RandomisedCarComboMixin, TankCarBase):
    """
