...
def main(**kwargs):
    ...
    model_def = ModelDef(
        schema_name="BulkOpenCarHeavyDuty",
        base_numeric_id=17110,
        gen=1,
        subtype="U",
        base_track_type="NG",
        speed=15,  # note rare non-standard speed, don't spill heavy things eh?
    ...
    model_def.add_unit_def(
        unit_cls_name="HeavyDutyCarUnit", chassis="4_axle_filled_16px"
    )
    ...
    model_def.add_unit_def(
        unit_cls_name="HeavyDutyCarUnit", chassis="4_axle_filled_24px"
    )
